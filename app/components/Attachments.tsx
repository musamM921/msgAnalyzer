...
interface AttachmentsInterface {
  attachmentsDetails: Array<any>;
}

const AttachmentsHeaders: React.FC<AttachmentsInterface> = ({attachmentsDetails}) => {
    return (
    ...
    <div className="flex flex-col pb-3">
        <dt className="mb-1 text-gray-500 md:text-lg dark:text-gray-400">{item.attachMimeTag}</dt>
